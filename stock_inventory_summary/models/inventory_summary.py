        ...
        for quant in quants:
            ...
            if to_date:
                quant_lines = lines.filtered(
                    ...
                    and (l.location_id.id == quant.location_id.id or l.location_dest_id.id == quant.location_id.id)
                )
            else:
                quant_lines = lines.filtered(
            ...
            in_quantities = in_lines.mapped(
                lambda l: l.product_uom_id._compute_quantity(l.quantity, l.product_id.uom_id)
            )
